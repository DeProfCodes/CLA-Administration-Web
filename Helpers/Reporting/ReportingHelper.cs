...
namespace CLA_Administration_Web.Helpers.Reporting
{
    public class ReportingHelper
    {
        ...
        public static string GetReportHTMLString(List<ReportRDLC> reportsRDLCs, string reportRDLCPath, string parameterValue = "")
        {
            try
            {
                ...
                byte[] renderedBytes = localReport.Render("HTML5", null, out _, out _, out _, out _, out _);
        ...
        public static PopupReportsRaw LoadPopupReportsTabs()
        {
            var data = ReportsMockData.GetReportingMockData().PopupReporting;

            var result = new PopupReportsRaw()
            {
        ...
        public static TickerReportsRaw LoadTickerReportsTabs()
        {
            var data = ReportsMockData.GetReportingMockData().TickerReporting;

            var result = new TickerReportsRaw()
            {
        ...
        public static SurveyReportsRaw LoadSurveyReportsTabs()
        {
            var data = ReportsMockData.GetReportingMockData().SurveyReporting;

            var result = new SurveyReportsRaw()
            {
        ...
        public static PolicyReportsRaw LoadPolicyReportsTabs()
        {
            var data = ReportsMockData.GetReportingMockData().PolicyReporting;

            var result = new PolicyReportsRaw()
            {
